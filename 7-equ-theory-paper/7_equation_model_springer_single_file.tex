...
(for discontinuous Galerkin discretizations). \tcb{Even if the numerical method under interest can be employed with both continuous 
and discontinuous schemes as mentioned above, our primary interest lies in continuous scheme, i.e. continuous finite element method.}
