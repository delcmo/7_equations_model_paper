...
the left-hand side of \eqt{eq:ent-res-7-eqn-diss-terms3} is non-negative if and only if (i) the phasic entropy function $s_k$ is concave with respect to $e_k$ and $\rho_k^{-1}$ and (ii) the following expressions for the viscous fluxes are employed: 
\begin{align}
