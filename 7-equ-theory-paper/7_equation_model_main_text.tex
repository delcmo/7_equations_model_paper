...
%
%---------------------------------------------------------------------------------
\subsection{Miminimum entropy principle}\label{sct:end-min-pr}
%---------------------------------------------------------------------------------
%
...
\end{subequations}
%
We also have proved in \sct{sct:positivity} that (i) the phasic volume fraction $\alpha_k$ remains bounded within a given interval, (ii) that the quantity $\alpha_k \rho_k$ is nonnegative, and (iii) that 
