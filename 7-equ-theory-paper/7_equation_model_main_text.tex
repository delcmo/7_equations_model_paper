...
Having real eigenvalues along with a set of linearly independent
eigenvectors are extremely valuable property for 
...
seven-equation two-phase flow equations using two test cases. The seven-equation model given in \eqt{eq:liq-7-eqn-sect5} is discretized
