...
\begin{figure}[H]
        ...
        \end{subfigure}
        \caption{Numerical solutions of the densities and volume fractions obtained using three different meshes (200, 400 and 800 cells) at $t=473 \ \mu s$.}\label{fig:density}
\end{figure}
%
From the phasic density profiles in \fig{fig:density-mult-meshes}, it is observed that the contact and the shock waves are better resolved as the mesh is refined. In other words, 
