...
\begin{figure}[H]
        ...
        \end{subfigure}
        \caption{Shock tube with nearly pure phases, 1000 cells.}\label{fig:nearly_pure}
\end{figure}


To show mesh convergence of the results, the same computation is now made on a mesh involving only
200 cells. The results are shown in \fig{fig:nearly_pure_compare}.
...
\begin{figure}[H]
        ...
        \end{subfigure}
        \caption{Shock tube with nearly pure phases, comparasison between 200 and 1000 cells.}\label{fig:nearly_pure_compare}
\end{figure}
