...
\tcr{to do what? I guess: obtain a numerical solution to the SEM} 
...
%-----------------------------------------------------------------------------------------------------------------------------
%
\tcr{not sure about the title. This section is not only about  $\alpha_k \rho_k$  ...}
...
(i) the phasic volume fraction $\alpha_k$ remains bounded within a given initial interval 
\tcr{ that sounds weird, if we start with alphak=0.5, your sentence implies we will always remain at alphak=0.5 ....}, 
