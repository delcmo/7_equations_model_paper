...
\tcr{theoretical (I want to convey the idea that we do a theoretical analysis, but show no numerical results. not sure this is the best wording)} 
limit-cases. First, a Chapman-Enskog expansion is performed for the regularized seven-equation two-phase flow model and we show that the five-equation flow 
model of Kapila a viscous regularization is obtained. Second, a low-Mach asymptotic limit of the regularized seven-equation flow model is carried out, \tcr{yielding blabla}. 
Our theoretical approach is illustrated with numerical results for 1-D shock tubes.
\end{abstract}
%-------------------------
%-------------------------
\begin{keyword}
seven-equation model \sep two-phase flow model \sep viscous regularization \sep artificial viscosity method \sep five-equation model of Kapilla \sep low-Mach asymptotics 
\end{keyword}
%-------------------------
\end{frontmatter}
%
