...
%-------------------------
%-------------------------
\title{Viscous Regularization for the Nonequilibrium Seven-Equation Two-Phase Flow Model}
%-------------------------
%-------------------------
...
%-------------------------
\begin{abstract}
In this paper, a viscous regularization is derived for the nonequilibrium Seven-Equation two-phase flow Model. The regularization ensures positivity of the entropy 
residual and uniqueness of the weak solution, is consistent with the viscous regularization for Euler equations when one phase disappears, does not depend on the spatial discretization scheme 
chosen, and is compatible with the generalized Harten entropies. We also investigate the behavior of the viscous regularization when the Seven-Equation two-phase flow Model degenerates to the five-equation two-phase flow model of Kapila while performing a Chapman-Enskog expansion. The low-Mach asymptotic limit is also investigated. Our theoretical approach is illustrated with numerical results of a 1-D shock tube.
\end{abstract}
%-------------------------
%-------------------------
\begin{keyword}
five-equation model of Kapilla \sep viscous regularization \sep seven-equation model \sep artificial dissipative method \sep low-Mach regime  
\end{keyword}
%-------------------------
\end{frontmatter}
%
...
physical and mathematical properties. Then in \sct{sec:visc-regu}, a viscous regularization is derived for the SEM and a Chapman-Enskog expansion of the 
regularized SEM is carried out to yield a regularized version of the five-equation two-phase flow model of Kapila. In \sct{sec:low-Mach}, a low-Mach asymptotic study for the regularized SEM is performed and possible definitions for artificial viscosity coefficients are outlines in order to ensure well-scaled dissipative terms. Our theoretical approach is illustrated in \sct{sec:num-ill} with numerical results for a 1-D two-phase shock tube. 
Finally, we conclude the study in \sct{sec:conclusion}.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
