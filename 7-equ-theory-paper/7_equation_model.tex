...
\end{equation}
%
\tcr{remind the reader of the beginning of section 4.1}
\begin{multline}
...
\tcr{recall what the model is: eq10+regular of eq.25}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Numerical illustrations}\label{sec:num-ill}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tcr{which equations??? Eq. 10 + regularization defined in Eq. 25. when malbda and mu are large, then it is equivalent to the 5-eq model}
