...
an analytical solution is available \cite{nozzle_exact}, (c) due to the different compressibilities between the phases,
...
\tcr{(note that the dissipative term in the volume fraction is not active because the volume fraction remains constant here)}. 
