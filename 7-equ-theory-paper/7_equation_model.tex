...
theoretical limit-cases. \tcr{ (I want to convey the idea that we do a theoretical analysis, but show no numerical results. not sure this is the best wording)} First, a Chapman-Enskog expansion is performed for the regularized seven-equation two-phase flow model and we show that the five-equation flow 
...
\tcr{nothing is said about the Chapman-Enskog study here, yet we ``advertize'' this in the abstract. It feels unbalanced...}
