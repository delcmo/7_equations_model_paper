...
\tcr{what is 'the' physical solution? is it unique? is there only one entropy solution? I think we shold be careful about the wording here} \tcb{we discussed it}
The viscous regularization also ensures nonnegativity of the entropy residual \tcr{check} \tcb{done}, is consistent with the viscous regularization for Euler equations 
