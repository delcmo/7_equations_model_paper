...
\end{align}
%
\tcr{in the equations just above, you had twice peclet kappa set to 1.} \tcb{you are right}
\end{remark}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
