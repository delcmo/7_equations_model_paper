...
\end{subequations}
%
where $\alpha_k$, $\rho_k$, $\mbold u_k$ and $E_k$ denote the void fraction, the density, the velocity vector and the total specific energy of phase $k$, respectively. The void fraction, mass, momentum and energy exchange terms from phase $k$ to phase $j$ are denoted by the symbols $\mathbb{S}_{k \to j}$, $\Gammakj$, $\mathbb{M}_{k \to j}$ and $\mathbb{E}_{k \to j}$, respectively, are determined by the method of rational thermodynamic \cite{Truesdell} and obey to the following relations: 
%
...
%---------------------------------------------------------------------------------
\subsection{Entropy equation of the SEM without viscous regularization and mathematical properties}\label{eq:sem-ent-wv}
%---------------------------------------------------------------------------------
