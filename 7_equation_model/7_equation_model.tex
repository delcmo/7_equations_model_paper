...
\end{subequations}
%
\tcr{the $\mathbb{aaa}$ symbol is reserved for rank-2 tensors. Please change to scalar, vector (math mbold), and tensor (mathbb) as appropriate to avoid confusion\\} \tcb{done}
...
%
\tcr{check sign. If Q is def negative, then I think we need $-$\\} \tcb{you are right}
