...
\end{multline}
%
\tcr{why a square in alpha inf? Also, if there is now an alpha inf, why isn't it appearing elsewhere?} 
...
%
\tcr{a $\gamma-1$ was missing I believe. Looks good now. Erase comment if you agree.}
\begin{multline}\label{eq:asympt_equ3_ener}
A \alpha_{k,0} \left[ \partial_t  P_k  + \mbold u_k \cdot \grad  P_k \right]_0 + \\ (\gamma-1) \alpha_{k,0} \div \left[ A \mbold u_k P_k \right]_0 +
