...
The remainder of the paper is as follows. In \sct{sec:7-equ-model}, the Seven-equation two-phase flow Model is recalled along with its main physical and mathematical properties. The viscous regularization is derived in \sct{sec:visc-regu} and a study of the scaled regularized equations is performed in \sct{sec:low-Mach} with a focus on the low-Mach asymptotic limit. 
