...
%---------------------------------------------------------------------------------
%
We start with the system of equations given in \eqt{eq:sev_equ}, where exchange terms have being omitted as explained in \sct{eq:sem-ent-wv},
...
\eqt{eq:ent-res-7-eqn-diss-terms-terms_rearranged} can be further simplified by using the following expressions
