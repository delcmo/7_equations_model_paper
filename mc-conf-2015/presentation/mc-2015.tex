...
\hspace{0.9cm} $\to$ Nonlinear system of equations \\
\hspace{0.9cm} $\to$ Fits the JFNK formalism in MOOSE
\end{block}
...
\ee
\item Plug in the standard Galerkin weak form as a \tcm{viscous regularization} 
\be
...
%%At steady state:
%%\begin{figure}
%%	\includegraphics[height=6cm, keepaspectratio=true]{figures/CylinderMach1em3ZoomIn.png}
...
%%\begin{frame} 
%%\begin{figure}
%	%\includegraphics[height=7cm, keepaspectratio=true]{figures/CylinderMach1em4ZoomIn.png}
...
%%\begin{frame} 
%%\begin{figure}
%	%\includegraphics[height=7cm, keepaspectratio=true]{figures/CylinderMach1em5ZoomIn.png}
...
%%\begin{frame} 
%%\begin{figure}
%	%\includegraphics[height=7cm, keepaspectratio=true]{figures/CylinderMach1em6ZoomIn.png}
...
%
%\begin{figure}
%	\includegraphics[height=6cm, keepaspectratio=true]{figures/CylinderMach1em7ZoomIn.png}
...
%\begin{figure}
%	\includegraphics[height=7cm, keepaspectratio=true]{figures/pressure_fluctuation.png}
%\end{figure}
%\end{frame}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%At steady state:
%\begin{figure}
%	\includegraphics[height=3cm, keepaspectratio=true]{figures/Hump2D_mach_0p7.png}
...
%\begin{figure}
%	\includegraphics[height=3cm, keepaspectratio=true]{figures/Hump2D_mach_0p01.png}
...
%%\begin{frame} 
%%\begin{figure}
%	%\includegraphics[height=3cm, keepaspectratio=true]{figures/Hump2D_mach_0p001.png}
%  %\caption{$M_{\text{inlet}}=10^{-3}$}
%%\end{figure}
%%\end{frame}
%
%%\begin{frame} 
%%\begin{figure}
%	%\includegraphics[height=3cm, keepaspectratio=true]{figures/Hump2D_mach_1em4.png}
%  %\caption{$M_{\text{inlet}}=10^{-4}$}
%%\end{figure}
%%\end{frame}
%
...
%\begin{figure}
%	\includegraphics[height=3cm, keepaspectratio=true]{figures/Hump2D_mach_1em7.png}
%  \caption{$M_{\text{inlet}}=10^{-7}$}
%\end{figure}
%\end{frame}
%
...
%%\begin{figure}
%    %\hspace*{-1cm}\includegraphics[width=0.65\textwidth]{figures/PWR_stt_temperature.png}
%    %\hspace*{-1cm}\includegraphics[width=0.65\textwidth]{figures/PWR_stt_viscosity.png}
%%\end{figure}
%%\end{frame}
%%************************************************
...
%%\begin{figure}
%    %\centering
%    %\includegraphics[width=0.98\textwidth]{figures/PWR_stt_viscosity.png}
%%\end{figure}
%%\end{frame}
%%************************************************
%%\begin{frame}{pressure and velocity}
%%\begin{figure}   
%    %\hspace*{-1cm}\includegraphics[width=0.65\textwidth]{figures/PWR_stt_pressure.png}
%    %\hspace*{-1cm}\includegraphics[width=0.65\textwidth]{figures/PWR_stt_velocity.png}
%%\end{figure}
%%\end{frame}
%%************************************************
...
%%\begin{figure}
%    %\centering
%    %\includegraphics[width=0.98\textwidth]{figures/PWR_stt_velocity.png}
%%\end{figure}
%%\end{frame}
%%************************************************
%
...
%%\begin{figure}
%    %\centering
%    %\includegraphics[width=0.98\textwidth]{figures/PWR_stt_momentum.png}
%%\end{figure}
%%\end{frame}
%%************************************************
%
...
%
%\begin{center}
%\movie[width=6cm,height=4cm,showcontrols=true,externalviewer]{\includegraphics[width=6cm,height=4cm]{engr.pdf}}{movies/compression_mach_number_movie.mpeg}\\
%\end{center}
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
%\begin{center}
%\movie[width=6cm,height=4cm,showcontrols=true,externalviewer]{\includegraphics[width=6cm,height=4cm]{engr.pdf}}{movies/compression_viscosity_movie.mpeg}\\
%\end{center}
%
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
