...
\cite{Toro, Lapidus_paper, LMP, Lapidus_book, Roe, SUPG}. Until recently and to the best of your knowledge, the 7-equation model was primarily spatially discretized using discontinuous schemes with approximate 
