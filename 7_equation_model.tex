...
\tcr{i cannot get $\mbold u_{int}  \cdot \grad \rho_k$. the void equation has $\mbold u_{int} \cdot \grad \alpha_k$, how do you go from $\grad \alpha_k$ to $\grad \rho_k$?? } \tcb{done}
%
