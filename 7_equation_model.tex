...
%-------------------------
%-------------------------
\title{Extension of the entropy viscosity method to the multi-D seven-equation two-phase flow model.\\
...
\section{Tracks for the definition of the phasic viscosity coefficients}\label{sec:low-Mach}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{itemize}
...
\end{equation}
%
Note that the phasic energy equation was recast under a non-conservative form by using the void fraction (\eqt{eq:sev_equ-with-diss-terms-vf_case_one_scaled}) to facilitate the derivations when trying to recover the divergence constraint onto the velocity.
...
%After describing the discretization scheme used (\sct{sec:solution_tech}), $1$-D numerical tests are performed in order to demonstrate the accuracy of our numerical method in \sct{sec:results}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
