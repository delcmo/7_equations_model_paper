...
%
At this point of the paper, the jumps and normalization parameters still have to be defined. More information about the jumps is provided in \sct{sec:solution_tech}. The normalization parameters are derived from a low-Mach asymptotic limit analysis which is the purpose of the next section.
%------------------------------------------------------------------------------------------------------
