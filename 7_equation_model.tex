...
%\item explain how to derive the dissipative term for the void fraction equation
...
%
%------------------------------------------------------------------------------------------------------
\subsection{Derivation of the scaled Seven-Equation Model}\label{sec:scaled-SEM}
%------------------------------------------------------------------------------------------------------
...
%fluid flow solutions (the seven-equation model was derived by assuming that each phase obeys the multi-dimensional Euler equations), namely, that the phasic pressure fluctuations are of the 
...
\end{equation}
%
Note that the phasic energy equation was recast under a non-conservative form by using the void fraction (\eqt{eq:sev_equ-with-diss-terms-vf_case_one_scaled}) to facilitate the derivations when trying to recover the divergence constraint onto the velocity in the low-Mach asymptotic regime.
...
%------------------------------------------------------------------------------------------------------
\subsection{Scaling of $\Re_{k,\infty}$, $\Pe_{k,\infty}^\kappa$ and $\Pe_{k,\infty}^\beta$ in the low-Mach asymptotic regime}\label{sec:low-Mach-sem}
%------------------------------------------------------------------------------------------------------
