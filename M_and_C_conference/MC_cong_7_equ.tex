...
In this paper, the regularized single and two-phase flow models are recalled along with the all-Mach flow definitions of the viscosity coefficients in \sct{act:model}. After detailing the spatial and temporal discretization method in \sct{sec:disc}, numerical results of a single and two-phase water-hammers are presented in \sct{sec:results}. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
