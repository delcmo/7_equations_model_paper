...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Compressible two-phase fluid flows are found in numerous scientific and industrial applications (astrophysical plasmas, 
...
A variety of two-phase models, with different levels of mechanical and thermodynamical non-equilibrium, exists. 
...
Unconditionally hyperbolic multiphase flow models have been derived by Stewart and Wendroff \cite{BruceStewart1984363}, Baer and
Nunziato \cite{BaerNunziato}, Kapila \cite{Kapila_2001}, Berry et al. \cite{Berry_1985}, Saurel et al. \cite{Saurel_2001a,Saurel_2001b}, 
among others. 
...
which pressure equilibrium is reached. 



, but other models multi-phase have been derived as well there are the five-equation model of Kapila \cite{Kapila_2001,GuillardMurrone2003,Saurel_2009} 
...
As the SEM is a hyperbolic system of equation, a Riemann solver could be used but is often ruled out because of the complexity due to the number of equations involved. An alternative is to use an approximate Riemann solver, a well-established approach for single-phase flows, while deriving a consistent discretization scheme for the non-conservative terms \cite{Li_2004,Abgrall_2002}. 
...
Careless approximation for the treatment of the non-conservative terms can lead to failure in computing the numerical solution \cite{Abgrall_2002}.
