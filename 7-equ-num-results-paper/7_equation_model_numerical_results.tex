...
\end{itemize}
%
The remainder of this paper presents new theoretical details (\sct{sec:visc-def}) for the application of the Entropy Viscosity Method to the inviscid Seven-Equation two-phase flow Model along with one dimensional numerical results (\sct{sec:results}) to valid our approach.
